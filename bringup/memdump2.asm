...
; address-space swap:
; A19 is held high by a flip-flop which means top and bottom half of address
; space is initially swapped.  So CPU initially boots from physical address
; $00080000. The flip-flop is reset upon setting A19 (calling into top-half
; address space).
